        ...
        <div className="p-8 rounded-3xl bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/10 shadow-xl backdrop-blur-xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Sign in to report and track lost items
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-2xl font-bold text-white text-base bg-emerald-500 hover:bg-emerald-400 transition-all duration-200 hover:scale-[1.02] hover:shadow-xl hover:shadow-emerald-500/30 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 mt-2"
            >
